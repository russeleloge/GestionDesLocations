...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item <?php echo e(setMenuClass('admin.gestarticles.', 'menu-open')); ?>">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.gestarticles.types')); ?>" 
                    class="nav-link <?php echo e(setMenuActive('admin.gestarticles.types')); ?> ">
                        <i class="nav-icon far fa-circle"></i>
                        <p>Type d'articles</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.gestarticles.articles')); ?>" 
                    class="nav-link <?php echo e(setMenuActive('admin.gestarticles.articles')); ?> ">
...
<?php /**PATH R:\apkGest\resources\views/components/menu.blade.php ENDPATH**/ ?>